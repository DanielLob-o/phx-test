defmodule PulseWeb.EventLiveTest do
  use PulseWeb.ConnCase

  import Phoenix.LiveViewTest
  import Pulse.DashboardFixtures

  @create_attrs %{event_text: "some event_text"}
  ...
  describe "Index" do
    ...
    test "updates event in listing", %{conn: conn, event: event} do
      ...
      assert html =~ "some updated event_text"
    end
